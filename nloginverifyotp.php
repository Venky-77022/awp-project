...
if (isset($_SESSION['vid'])&&isset($_SESSION['nid'])&&isset($_SESSION['mbn'])&&isset($_SESSION['otp'])&&isset($_POST['otpv'])) {
...
$nid=$_SESSION['nid'];
 if ($otp==$user_otp) {
  ...
  echo "<script>alert('otp verified sucessfully')</script>";
                    ...
                    echo '<script> window.location.assign("nprofilesubmitform.php");</script>';
 }
